...
export const metadata: Metadata = {
  ...
  description: `${APP_NAME} is a modern UAE real estate platform that helps you discover, explore, and reserve your next home with ease. Browse properties, save favorites, book visits, and make confident decisions with a seamless experience.`,
  openGraph: {
    title: APP_NAME,
