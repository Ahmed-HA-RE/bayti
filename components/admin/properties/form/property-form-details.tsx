...
const PropertyFormDetails = ({
  ...
  return (
    <Card className='border-0 shadow-none gap-10'>
      <CardHeader className='flex items-center gap-2.5 px-0'>
        <span className='py-1 px-3 bg-orange-50 text-accent text-sm rounded-full'>
          1
        </span>
      ...
      <CardContent className='px-2'>
        <FieldGroup className='gap-6'>
          ...
          <Card
            ...
            className={cn(
              'rounded-xl border group transition-colors duration-200 max-w-xl',
              isChecked
