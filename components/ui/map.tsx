...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className='flex flex-col rounded-md bg-background shadow-md overflow-hidden [&>button:not(:last-child)]:border-b [&>button:not(:last-child)]:border-border'>
      {children}
    </div>
  );
}
...
function ControlButton({
  ...
  return (
    <button
      ...
      type='button'
      className={cn(
        'flex items-center justify-center size-8 bg-white transition-colors cursor-pointer hover:bg-[#ff6b00] hover:text-white',
