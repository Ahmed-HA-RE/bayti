...
const navigationMenuTriggerStyle = cva(
  'group inline-flex h-9 w-max items-center justify-center rounded-md text-sm font-medium transition-[color,box-shadow] outline-none hover:text-accent focus:bg-orange-50 focus:text-accent disabled:pointer-events-none disabled:opacity-50 data-[state=open]:text-accent data-[state=open]:hover:bg-none data-[state=open]:focus:bg-orange-50 cursor-pointer',
);
