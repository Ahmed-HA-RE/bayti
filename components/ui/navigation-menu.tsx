...
const navigationMenuTriggerStyle = cva(
  'hover:font-semibold focus:bg-background data-open:focus:bg-muted data-open:bg-0 focus-visible:ring-ring/50  data-popup-open:hover:bg-transparent rounded-lg text-base font-medium transition-all focus-visible:ring-3 focus-visible:outline-1 disabled:opacity-50 group/navigation-menu-trigger inline-flex h-10 w-max items-center justify-center disabled:pointer-events-none outline-none text-foreground shadow-none font-normal',
);
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "data-active:focus:bg-muted focus-visible:ring-ring/50 focus:bg-muted flex items-center gap-2 rounded-lg text-sm transition-all outline-none focus-visible:ring-3 focus-visible:outline-1 in-data-[slot=navigation-menu-content]:rounded-md [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
