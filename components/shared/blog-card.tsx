...
const BlogCard = ({ blog }: { blog: Blog }) => {
  ...
  return (
    ...
    >
      <Card className='rounded-lg pb-0 gap-0 transition-shadow duration-300 hover:shadow-lg overflow-hidden'>
        ...
        <CardContent className='px-0'>
          <Button
            variant='link'
            className='px-4 my-8 underline underline-offset-4 gap-1.5'
          >
          ...
          <div className='overflow-hidden'>
            <Image
              ...
              height={0}
              sizes='100vw'
              className='object-cover w-full h-[260px] group-hover:scale-105 transition-transform duration-500'
            />
          </div>
        </CardContent>
      </Card>
